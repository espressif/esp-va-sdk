...
static char *utils_strcasestr(const char *s, const char *find)
{
...
char *get_xml_tag_value(char *buffer, const char *tag)
{
    ...
    char *found_open = utils_strcasestr(buffer, open_tag);
    char *found_close = utils_strcasestr(buffer, close_tag);
