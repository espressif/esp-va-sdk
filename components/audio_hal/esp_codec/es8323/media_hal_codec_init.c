...
{
    media_hal->audio_codec_initialize = es8323_init;
    media_hal->audio_codec_deinitialize = es8323_deinit;
    media_hal->audio_codec_set_state = es8323_set_state;
    media_hal->audio_codec_set_i2s_clk = es8323_set_i2s_clk;
    media_hal->audio_codec_config_format = es8323_config_format;
    media_hal->audio_codec_control_volume = es8323_control_volume;
    media_hal->audio_codec_get_volume = es8323_get_volume;
    media_hal->audio_codec_set_mute = es8323_set_mute;
    media_hal->audio_codec_powerup = es8323_powerup;
    media_hal->audio_codec_powerdown = es8323_powerdown;
}
