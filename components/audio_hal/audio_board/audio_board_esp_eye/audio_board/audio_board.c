...
esp_err_t audio_board_i2s_pin_config(int port_num, i2s_pin_config_t *pf_i2s_pin)
{
    ...
    switch(port_num) {
        case 0:
            ...
            pf_i2s_pin->bck_io_num = 26;    // IIS_SCLK
            pf_i2s_pin->ws_io_num = 32;     // IIS_LCLK
            pf_i2s_pin->data_out_num = -1;  // IIS_DSIN
            pf_i2s_pin->data_in_num = 33;   // IIS_DOUT
            break;
        case 1:
            pf_i2s_pin->bck_io_num = 26;    // IIS_SCLK
            pf_i2s_pin->ws_io_num = 32;     // IIS_LCLK
...
esp_err_t audio_board_i2s_init_default(i2s_config_t *i2s_cfg_dft)
{
    ...
    i2s_cfg_dft->tx_desc_auto_clear = false;
    i2s_cfg_dft->fixed_mclk = -1;
