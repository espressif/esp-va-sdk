...
{                                           \
    ...
    .pin_conf.spi_miso_pin = 34,            \
    .pin_conf.spi_clk_pin = 22,             \
    .pin_conf.apr_cs_pin = 32,              \
    .pin_conf.vt_cs_pin = 33,               \
    .fw_conf.total_mics_num = TOTAL_2_MICS, \
...
static esp_err_t va_board_button_init()
{
    button_driver_config_t button_driver_config = {
        ...
        .tolerance = 45,
        .button_val = {
            [BUTTON_EVENT_TAP_TO_TALK] = 610,
            [BUTTON_EVENT_MIC_MUTE] = 1860,
            [BUTTON_EVENT_VOLUME_UP] = -1,
            [BUTTON_EVENT_VOLUME_DOWN] = -1,
            [BUTTON_EVENT_FACTORY_RST] = 520,
            [BUTTON_EVENT_CUSTOM_1] = -1,
            [BUTTON_EVENT_CUSTOM_2] = -1,
            [BUTTON_EVENT_IDLE] = 3100,
        },
    };
