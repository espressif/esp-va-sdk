 ...
 *
 * This API should be called by the application to change the mute state of the speaker.
 * The mute is enabled/disabled instantly. Also a callback event for mute changed is sent * to the voice assistant.
 * the call.
 *
 * \param[in] vol Volume represented in percentage. Allowed range is 0-100.
 *
